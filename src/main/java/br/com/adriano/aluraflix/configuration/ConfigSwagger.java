...
public class ConfigSwagger {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				.apis(RequestHandlerSelectors.basePackage("br.com.adriano.aluraflix")).paths(PathSelectors.any())
				.build().apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {
		return new ApiInfo("Rest API AluraFlix Spring Boot", "Plataforma para conpartilhamento de videos", "v1",
